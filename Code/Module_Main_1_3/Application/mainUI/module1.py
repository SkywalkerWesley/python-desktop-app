...
from Code.Module_Main_1_3.Application.CustomWidgets.SamplePlotsWidget import SamplePlotsWidget
...
################################################# User Interface Creation #################################################
    ...
    def customCalculationPlotsUI(self):
        self.SamplePlotsWidget = SamplePlotsWidget("ln(Mass44 - CO2Zero44)", "ln(Mass45 - CO2Zero45)", self.getVarsDict)
        self.SamplePlotsWidget.softError.connect(
            lambda title, msg: self.throwTellUserDilog(title, msg)
        )
        # self.SamplePlotsWidget.div2Graph.connect(
        #     lambda x, y:
        #     self.SamplePlotsWidget.calculationPlotGraph2.plot(
        #         x, y,
        #         pen=pg.mkPen(color=(255, 0, 0), width=2, style=QtCore.Qt.DashLine)
        #     )
        # )
        #
        # self.SamplePlotsWidget.dataGraph.connect(
        #     lambda x, y:
        #     self.SamplePlotsWidget.calculationPlotGraph.plot(
        #         x, y,
    ...
    def initializeQFrames(self):
        ...
        innerScroll.setWidget(self.SamplePlotsWidget)
